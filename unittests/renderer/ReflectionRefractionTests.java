...
public class ReflectionRefractionTests {
    ...
    public void myShapeBox() {
        ...
        geometries.setBoundingBox(new Point(4.6, 4.6, 0.3), new Point(-4.6, -4.6, 38.5));
        ...
        //scene.lights.add(new SpotLight(new Color(white).reduce(2), new Point(20.43303,-7.37104,13.77329), new Vector(-20.43,7.37,-13.77)));
        ImageWriter imageWriter = new ImageWriter("cadurBox", 15000, 15000);
        camera.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene)) //
                .renderImage() //
                .writeToImage();
    ...
    public void checkColor2() {
        ...
        //scene.lights.add(new SpotLight(new Color(white).reduce(2), new Point(20.43303, -7.37104, 13.77329), new Vector(-20.43, 7.37, -13.77)));
        ImageWriter imageWriter = new ImageWriter("cadurim", 500, 500);
        camera.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene)) //
                .renderImage() //
                .writeToImage();
    ...
    public void checkColor3() {
        ...
        scene.geometries.add(new Plane(new Point(-6, 0, -5.3), new Point(-6, 8, -5.3), new Point(6, 8, -5.3))
                .setEmission(new Color(black).scale(1)).setMaterial(new Material().setKd(0.005).setKs(0.001).setShininess(10).setKr(0.6).setBlurGlass(10,5,1)))
        ;
        ...
        scene.geometries.add(new Sphere(new Point(0.64, 2.5, 0.5001), 0.5).setEmission(new Color(0, 0, 0))
                .setMaterial(new Material().setKd(0.01).setKs(0.2).setShininess(2).setKr(0.6).setBlurGlass(2, 6, 1))
        );
        ...
        ImageWriter imageWriter = new ImageWriter("check4", 20000, 20000);
        camera.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene)) //
                .renderImage() //
                .writeToImage();
    ...
    @Test
    public void checkColor3box() {

        Vector vTo = new Vector(50, 4, -50);
        Vector vUp = new Vector(50, 0, 50);

        Point camera_point = new Point(-11, 2, 5).add(vTo.scale(-0.4));
        Camera camera = new Camera(camera_point, vTo, vUp)
                .setVPSize(200d, 200).setVPDistance(100);
        ;
        ...
        Geometries planOfTable = new Geometries(
                new Polygon(new Point(6, 0, 0), new Point(-6, 0, 0), new Point(-6, 8, 0), new Point(6, 8, 0))
                        .setEmission(new Color(0, 153, 76).reduce(1.3)).setMaterial(new Material().setKd(0.01).setKs(.002).setShininess(0).setKt(0.7))
                ,
        ...
        Geometries balls = new Geometries(
                ...
                //row 1
                new Sphere(new Point(-2, 4, 0.5001), 0.5).setEmission(new Color(250, 235, 215).reduce(1.6))
                        .setMaterial(new Material().setKd(0.2).setKs(0.1).setShininess(10).setKt(0.01))
                ,

                //row 2
                new Sphere(new Point(-1.12, 3.5, 0.5001), 0.5).setEmission(new Color(red))
                        .setMaterial(new Material().setKd(0.001).setKs(0.2).setShininess(20).setKt(0.5))
                ,

                //purple
                new Sphere(new Point(-1.12, 4.5, 0.5001), 0.5).setEmission(new Color(139, 0, 139))
                        .setMaterial(new Material().setKd(0.2).setKs(0).setShininess(10).setKt(0))
                ,


                //row 3
                new Sphere(new Point(-0.24, 5, 0.5001), 0.5).setEmission(new Color(255, 20, 147))
                        .setMaterial(new Material().setKd(0.002).setKs(0.002).setShininess(0).setKt(0))
                ,

                new Sphere(new Point(-0.24, 4, 0.5001), 0.5).setEmission(new Color(black))
                        .setMaterial(new Material().setKd(0.2).setKs(1).setShininess(80).setKt(0))
                ,

                new Sphere(new Point(-0.24, 3, 0.5001), 0.5).setEmission(new Color(yellow).reduce(1.6))
                        .setMaterial(new Material().setKd(0.001).setKs(0.002).setShininess(1).setKt(0.01))
                ,

                //row 4
                new Sphere(new Point(0.64, 5.5, 0.5001), 0.5).setEmission(new Color(blue))
                        .setMaterial(new Material().setKd(0.2).setKs(0).setShininess(10).setKt(0))
                ,

                new Sphere(new Point(0.64, 4.5, 0.5001), 0.5).setEmission(new Color(blue))
                        .setMaterial(new Material().setKd(0.2).setKs(0).setShininess(10).setKt(0))
                ,

                new Sphere(new Point(0.64, 3.5, 0.5001), 0.5).setEmission(new Color(blue).reduce(5))
                        .setMaterial(new Material().setKd(0.2).setKs(0.3).setShininess(1).setKt(0.2))//.setBlurGlass(9,5,1.3))
                ,
                new Sphere(new Point(0.64, 2.5, 0.5001), 0.5).setEmission(new Color(0, 0, 0))
                        .setMaterial(new Material().setKd(0.01).setKs(0.2).setShininess(2).setKr(0.6).setBlurGlass(2, 6, 1))

        );

        planOfTable.add(balls);
        table.add(planOfTable);
        ...
        //scene.lights.add(new SpotLight(new Color(white).reduce(1), new Point(20.43303, -7.37104, 13.77329), new Vector(-20.43, 7.37, -13.77)));
        ImageWriter imageWriter = new ImageWriter("check4ballsbox", 20000, 20000);
        camera.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene)) //
                .renderImage() //
                .writeToImage();
