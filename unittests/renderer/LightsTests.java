...
public class LightsTests {
	...
	public void multiLight() {
		 ...
		 Geometry sphere1 = new Sphere(new Point(20,-1.5,0.8),2).
				 setMaterial(new Material().setKd(  0.85).setKs(0.15 ).setShininess(100)).
				 setEmission(new Color(yellow).reduce(4.0) );

		 Geometry sphere2 = new Sphere(new Point(30,1.5,0.5),2.6).
		         setMaterial(new Material().setKd(0).setKs(1).setShininess(300)).
				 setEmission(new Color( red).scale(2));
		...
		scene3.geometries.add(sphere1,sphere2);
		 ...
		 scene3.lights.add(new PointLight(new Color(green).scale(5),new Point(25,0,0))
				 .setKq(0.7)
				 .setKl(0.2)
				 .setKc(0.1));

		scene3.lights.add(new DirectionalLight( new Color( white).reduce(6.2), new Vector(0,-1,1)) );

		scene3.lights.add(new SpotLight(new Color(white).reduce(2), new Point(18.5,-9,8.5)
				                        ,new Vector(-1.5,7.5,-7.7))  );


		ImageWriter imageWriter = new ImageWriter("multilights", 1000, 1000);
	...
	public void trianglesMultiLight() {
		...
		scene2.lights.add(new SpotLight(trCL, new Point(10,30,-100), trDL)/*.setNarrowBeam(10)*/.setKl(0.001).setKq(0.00004));

		scene2.lights.add(new DirectionalLight(new Color(white).reduce(2), new Vector(0, 0, -1)));
	...
	public void trianglesSpotSharp1() {
		...
		Scene scene3 = new Scene("pyramid")
				.setAmbientLight(new AmbientLight(new Color(white).scale(0.8), new Double3(0.8)))
				.setBackground(new Color(BLACK).scale(0.7) );
		...
		scene3.lights.add(new PointLight(new Color(white).reduce(2),new Point(2,2,20))
				.setKq(0.7)
				.setKl(0.2)
				.setKc(0.1));

		//scene3.lights.add(new DirectionalLight( new Color( white).reduce(6.2), new Vector(30,25,-1)) );

		scene3.lights.add(new SpotLight(new Color(white).reduce(2), new Point(0,0,20)
				,new Vector(0,0,-1))  );
	...
	public void sphereMultiLight() {
		...
		scene1.lights.add(new SpotLight( new Color(green).scale(3), new Point(50, 50, 25), new Vector(-1, -1, -0.5)).setKl(0.001).setKq(0.0001));
